    ...
    data: [
        ...
        },
        {
            ...
            attributes: {
                ...
                nativeBalanceMethodTemplate: "0x276c90850b9de2c495875fe945d2a9c7b99d880ec681799c0cf30e8886371da9{Blake2_128Concat,0}55c5ce389310185c39a3ca86bf21c7bd736e656700000000",
                ...
                xcm: {
                    args: [
                        ...
                        {
                            type: "value",
                            value: "0x0000000000000000000000000000007a05c51f15d366ac77bc86672166836100",
                        },
                    ],
        ...
        },
        {
            ...
            attributes: {
                ...
                nativeToken: "gens",
                balanceMethodTemplate: "0x276c90850b9de2c495875fe945d2a9c7b99d880ec681799c0cf30e8886371da9{Blake2_128Concat,0}{Blake2_128Concat,assetId}",
        ...
        },
        {
            ...
            attributes: {
                ...
                nodes: "wss://parachain-testnet.equilab.io/statemint/collator/node1/wss",
                nativeBalanceMethodTemplate: "0x26aa394eea5630e07c48ae0c9558cef7b99d880ec681799c0cf30e8886371da9{Blake2_128Concat,0}",
                nativeBalanceReturnType: "AccountInfo",
                nativeBalanceParser: "data.free,10",
        ...
        },
        {
            ...
            attributes: {
                ...
                nodes: "wss://statemint-rpc.polkadot.io;wss://statemint.api.onfinality.io/public-ws;wss://statemint-rpc.dwellir.com;wss://public-rpc.pinknode.io/statemint;wss://statemint.public.curie.radiumblock.co/ws",
                nativeBalanceMethodTemplate: "0x26aa394eea5630e07c48ae0c9558cef7b99d880ec681799c0cf30e8886371da9{Blake2_128Concat,0}",
                nativeBalanceReturnType: "AccountInfo",
        ...
        },
        {
            ...
            attributes: {
                ...
                nativeBalanceMethodTemplate: "0x26aa394eea5630e07c48ae0c9558cef7b99d880ec681799c0cf30e8886371da9{Blake2_128Concat,0}",
                nativeBalanceReturnType: "AccountInfo",
                nativeBalanceParser: "withDecimals(minus(result(data, free),result(data, miscFrozen)), 18)",
                title: "Astar",
                xcm: {
                    args: [
                        {
        ...
        },
        {
            ...
            attributes: {
                ...
                nativeBalanceMethodTemplate: "0x99971b5749ac43e0235e41b0d37869188ee7418a6531173d60d1f6a82d8f4d51{Blake2_128Concat,0}c483de2de1246ea70002",
